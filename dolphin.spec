...
Version  : 18.11.90
Release  : 15
URL      : https://github.com/KDE/dolphin/archive/v18.11.90.tar.gz
Source0  : https://github.com/KDE/dolphin/archive/v18.11.90.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1543744305
mkdir -p clr-build
pushd clr-build
%cmake ..
