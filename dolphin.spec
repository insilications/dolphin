...
Source0  : https://download.kde.org/stable/release-service/20.12.1/src/dolphin-20.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.12.1/src/dolphin-20.12.1.tar.xz.sig
...
%prep
%setup -q -n dolphin-20.12.1
cd %{_builddir}/dolphin-20.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610039532
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/dolphin-20.12.1/COPYING %{buildroot}/usr/share/package-licenses/dolphin/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/dolphin-20.12.1/COPYING.DOC %{buildroot}/usr/share/package-licenses/dolphin/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
cp %{_builddir}/dolphin-20.12.1/LICENSES/BSD-2-Clause.txt %{buildroot}/usr/share/package-licenses/dolphin/680ed9349d3d12bd39ddd36e8c4bc6b1b0cb1c0e
cp %{_builddir}/dolphin-20.12.1/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/dolphin/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/dolphin-20.12.1/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/dolphin/2a638514c87c4923c0570c55822620fad56f2a33
cp %{_builddir}/dolphin-20.12.1/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/dolphin/e712eadfab0d2357c0f50f599ef35ee0d87534cb
cp %{_builddir}/dolphin-20.12.1/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/dolphin/6091db0aead0d90182b93d3c0d09ba93d188f907
cp %{_builddir}/dolphin-20.12.1/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/dolphin/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/dolphin-20.12.1/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/dolphin/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/dolphin-20.12.1/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/dolphin/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/dolphin-20.12.1/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/dolphin/7d9831e05094ce723947d729c2a46a09d6e90275
pushd clr-build
%make_install
popd
