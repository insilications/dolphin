...
Version  : 18.08.0
Release  : 8
URL      : https://github.com/KDE/dolphin/archive/v18.08.0.tar.gz
Source0  : https://github.com/KDE/dolphin/archive/v18.08.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1535425199
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
