...
Version  : 18.12.1
Release  : 20
URL      : https://github.com/KDE/dolphin/archive/v18.12.1.tar.gz
Source0  : https://github.com/KDE/dolphin/archive/v18.12.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1547424173
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
