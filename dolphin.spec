...
Source0  : https://download.kde.org/stable/release-service/21.12.2/src/dolphin-21.12.2.tar.xz
...
%prep
%setup -q -n dolphin-21.12.2
cd %{_builddir}/dolphin-21.12.2
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645276641
mkdir -p clr-build
pushd clr-build
