...
Version  : 18.12.0
Release  : 17
URL      : https://github.com/KDE/dolphin/archive/v18.12.0.tar.gz
Source0  : https://github.com/KDE/dolphin/archive/v18.12.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1544882616
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
