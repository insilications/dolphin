...
Version  : 20.08.3
Release  : 47
URL      : https://download.kde.org/stable/release-service/20.08.3/src/dolphin-20.08.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/20.08.3/src/dolphin-20.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.08.3/src/dolphin-20.08.3.tar.xz.sig
...
%prep
%setup -q -n dolphin-20.08.3
cd %{_builddir}/dolphin-20.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1604591811
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/dolphin-20.08.3/COPYING %{buildroot}/usr/share/package-licenses/dolphin/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/dolphin-20.08.3/COPYING.DOC %{buildroot}/usr/share/package-licenses/dolphin/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
pushd clr-build
%make_install
popd
%find_lang dolphin
