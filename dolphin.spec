...
Version  : 18.04.3
Release  : 3
URL      : https://github.com/KDE/dolphin/archive/v18.04.3.tar.gz
Source0  : https://github.com/KDE/dolphin/archive/v18.04.3.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1532653083
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
