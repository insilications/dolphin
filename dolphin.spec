...
Version  : 18.08.2
Release  : 11
URL      : https://github.com/KDE/dolphin/archive/v18.08.2.tar.gz
Source0  : https://github.com/KDE/dolphin/archive/v18.08.2.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1539272150
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
