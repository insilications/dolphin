...
Version  : 18.08.1
Release  : 9
URL      : https://github.com/KDE/dolphin/archive/v18.08.1.tar.gz
Source0  : https://github.com/KDE/dolphin/archive/v18.08.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1536299311
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
