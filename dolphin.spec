...
Version  : 18.08.3
Release  : 12
URL      : https://github.com/KDE/dolphin/archive/v18.08.3.tar.gz
Source0  : https://github.com/KDE/dolphin/archive/v18.08.3.tar.gz
...
%package abi
Summary: abi components for the dolphin package.
Group: Default

%description abi
abi components for the dolphin package.
...
export LANG=C
export SOURCE_DATE_EPOCH=1541689041
mkdir -p clr-build
pushd clr-build
%cmake ..
...
%files abi
%defattr(-,root,root,-)
/usr/share/abi/libdolphinprivate.so.5.0.0.abi
/usr/share/abi/libdolphinprivate.so.5.abi
/usr/share/abi/libdolphinvcs.so.5.0.0.abi
/usr/share/abi/libdolphinvcs.so.5.abi
