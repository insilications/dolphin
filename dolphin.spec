...
Version  : 21.12.2
Release  : 329
URL      : file:///aot/build/clearlinux/packages/dolphin/dolphin-v21.12.2.tar.gz
Source0  : file:///aot/build/clearlinux/packages/dolphin/dolphin-v21.12.2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645274552
mkdir -p clr-build
pushd clr-build
